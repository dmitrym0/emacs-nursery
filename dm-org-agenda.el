...
(defun dm/update-agenda-file-list (&rest args)
  ...
  (setq org-agenda-files (flatten-tree
                          (append (dm/get-agenda-files-with-keyword "\\*\\s+TODO") `(,(concat org-directory "gcal.org") ,(concat org-directory "kayen-cal.org") ,(concat org-directory "maya-cal.org") ,(concat org-directory "vt-cal.org"))))))
